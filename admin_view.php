...
<h1 id="main_title">Employee Details</h1>
<div class="container">
    ...
    <thead>
     ...
     <tbody>
        <?php
            ...
            if(isset($_GET['fr_code'])){
                $fr_code = $_GET['fr_code'];

                $query = "SELECT * FROM students WHERE fr_code = '$fr_code'";
        ...
        <tr>
            ...
            <td>
                <?php
                    if($row['status']==1){
                        echo '<p><a href="status.php?id='.$row['id'].'&status=0" 
                        class="btn btn-primary">Active</a></p>';
                    }
                    else{
                        echo '<p><a href="status.php?id='.$row['id'].'&status=1" class="btn btn-blue">Inactive</a></p>';
                    }
